...
public class ProductWithImagesCategoryAndSizesDto {
	...
	public ProductWithImagesCategoryAndSizesDto(Product product) {
		...
		this.sizes = product.getAvailableSizes().stream().map(Size::name).collect(Collectors.toList());
	}
